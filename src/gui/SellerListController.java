...
public class SellerListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableView<Seller> tableViewSeller; // INSTANCIA A TABLE VIEW COM DEPARTMENT DE ARGUMENTO

	@FXML
	private TableColumn<Seller, Integer> tableColumnId; // COLUNA 1
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) { // JANELA MODAL
		try {
			...
			dialogStage.initModality(Modality.WINDOW_MODAL); // GARANTE QUE A JANELA É MODAL, BLOQUEA AS JANELAS
																// ANTERIORES

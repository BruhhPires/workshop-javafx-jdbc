...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	private void initializeNodes() { // INICIA O COMPORTAMENTO DAS COLUNAS
		...
		Stage stage = (Stage) Main.getMainScene().getWindow(); // PEGA UMA REFERENCIA PRO STAGE DO GETWINDOWN E FAZ O
																// DOWNCAST
		tableViewDepartment.prefHeightProperty().bind(stage.heightProperty()); // GARANTE QUE O TABLEVIEW ACOMPANHE A
																				// JANELA
	}
	...
	private void createDialogForm(Department obj, String absoluteName, Stage parentStage) { // JANELA MODAL
		try {
